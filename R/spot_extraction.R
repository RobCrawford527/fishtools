#' Extract Spot Data For A Single Cell From FISH-QUANT File
#'
#' @param file File from FISH-QUANT (imported using readLines)
#' @param start Line index to start reading from ("SPOTS_START")
#' @param end Line index to finish reading from ("SPOTS_END")
#'
#' @return Data frame containing spot data for a single cell in tidy format
#'
